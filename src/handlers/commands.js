...
async function handleHelp(ctx) {
  await ctx.reply(
    ...
    + '• Role-play — /talk (Guided Talk: готовые фразы + озвучка)\n'
    ...
    + '• Support-ассистент — напиши вопрос о боте обычным сообщением\n\n'
    + '**Команды** (кнопка «/» в чате):\n'
    + '/start — онбординг / главное меню\n'
    + '/reset — сбросить историю чата с support-ассистентом\n'
