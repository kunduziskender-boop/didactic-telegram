...
const config = {
  ...
  ragMatchThreshold: Number(process.env.RAG_MATCH_THRESHOLD ?? 0.6),
  ragMatchRpc: process.env.RAG_MATCH_RPC || 'match_kb_chunks',
  ragContextMaxChars: Number(process.env.RAG_CONTEXT_MAX_CHARS ?? 1800),
